...
<root>
  ...
  ├── Editor
  │   ├── norlo.Exceltoarray.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── norlo.Exceltoarray.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── norlo.Exceltoarray.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── norlo.Exceltoarray.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `norlo.Exceltoarray`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package ExcelToArray Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/norlo.Exceltoarray.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/norlo.Exceltoarray.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/norlo.Exceltoarray.Editor.Tests.asmdef`

  `Tests/Runtime/norlo.Exceltoarray.Tests.asmdef`
